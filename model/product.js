...
class Product {
  ...
  static add(product) {
    if (validator.isValid(product.name) &&
      validator.isValueValid(product.value) &&
      validator.isCapacityValid(product.capacity) &&
      validator.isPriceValid(product.price) &&
      validator.isValidId(product.rate) &&
      validator.isPicturePathValid(product.picturePath) &&
      validator.isValid(product.note) &&
      validator.isValid(product.description) &&
      validator.isValidId(product.producer.IdProducer)
    ) {
      return db.execute(
